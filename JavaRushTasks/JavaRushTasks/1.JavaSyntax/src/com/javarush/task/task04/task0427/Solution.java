...
public class Solution {
    public static void main(String[] args) throws Exception {
        ...
        if (number1>0 && number1<10 && number1%2==0) System.out.println("четное однозначное число");
        if (number1>0 && number1<10 && number1%2==1) System.out.println("нечетное однозначное число");
        if (number1>9 && number1<100 && number1%2==0) System.out.println("четное двузначное число");
        if (number1>9 && number1<100 && number1%2==1) System.out.println("нечетное двузначное число");
        if (number1>99 && number1<1000 && number1%2==0) System.out.println("четное трехзначное число");
        if (number1>99 && number1<1000 && number1%2==1) System.out.println("нечетное трехзначное число");
