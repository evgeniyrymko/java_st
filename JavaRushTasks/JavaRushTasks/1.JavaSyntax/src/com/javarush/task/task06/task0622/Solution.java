...
public class Solution {
    public static void main(String[] args) throws Exception {
        ...
        int el1 = Integer.parseInt(reader.readLine());
        int el2 = Integer.parseInt(reader.readLine());
        int el3 = Integer.parseInt(reader.readLine());
        int el4 = Integer.parseInt(reader.readLine());
        int el5 = Integer.parseInt(reader.readLine());
        int array[] = {el1, el2, el3, el4, el5};
        Arrays.sort(array);
