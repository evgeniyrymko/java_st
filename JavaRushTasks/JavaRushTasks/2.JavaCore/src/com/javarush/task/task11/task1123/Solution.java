...
public class Solution {
    ...
    public static Pair<Integer, Integer> getMinimumAndMaximum(int[] inputArray) {
        ...
        int array1[]=new int[inputArray.length];
        System.arraycopy(inputArray,0,array1,0,inputArray.length);
        Arrays.sort(array1);


        return new Pair<Integer, Integer>(array1[0], array1[array1.length-1]);
    }
